...
The planets and moons of the Solar System are complex systems, with differences in climate and atmospheric composition. 

Tidally locked exoplanets are an extreme example of this variation, with a hot, continuously irradiated dayside and a much colder nightside.

a wide range of climate, weather, topography, atmospheres mediating the exchange of radiation 
...
It is a challenge is to reveal this structure for exoplanets at great distances, when we cannot spatially resolve the photosphere.  Most observations of exoplanet atmospheres use techniques that are sensitive to one average region  -- either the terminator, for transmission spectroscopy, or the disk-integrated dayside, for emission spectroscopy.  

The solution to this problem is to observe phase curves of tidally-locked planets, which monitor the brightness of the planet over its entire orbit. As the orbital phase changes, the observer 

The first phase curve was observed with \Spitzer\ for the hot Jupiter HD 189733b by \citep{knutson07}, which revealed a modest day-night temperature contrast of 300 Kelvin
...
WASP-103b is an ideal candidate for phase curve observations, with an orbital period of just FIXME hours \citep{gillon14}. Its equilibrium temperature is FIXME K, . The atmosphere of WASP-103b has been characterized with transmission and emission spectroscopy \citep{southworth16, cartier17, lendl17}. The thermal emission spectrum is featureless 

In this paper we present the spectroscopic phase curve observations of WASP-103b. Our data observed with \HST/WFC3  
