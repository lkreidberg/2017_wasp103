...
We also fit indepedent blackbody models to the \HST/WFC3 data and each \Spitzer\ channel. The resulting brightness temperatures are listed in Table\,\ref{table:teffs}. The WFC3 data are fit well by a blackbody model at all orbital phases (consistent at better than $1.5\,\sigma$). The brightness temperatures FIXME talk about significance of features.
