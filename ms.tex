...
The structure of the paper is the following: in \S\,\ref{sec:observations} we describe the observations and data reduction. \S\,\ref{sec:fits} details the models fit to the phase curves. \S\,\ref{sec:results} we discuss results, including the phase curve amplitudes and hotspot offsets, the phase-resolved spectra, and estimates of the planet's climate. In \S\,\ref{sec:gcm} and \ref{sec:comparison}, we compare the observations to GCM predictions and spectra from similar temperature stars and directly imaged companions. \S\,\ref{sec:summary} concludes.
