...
\begin{deluxetable}{LLLLL}
	...
	\colhead{\,} & \colhead{WFC3} & \colhead{Ch. 1} & \colhead{Ch. 2} & \colhead{(9 dof)}}
		\startdata
		0.06 - 0.15 & 1917 \pm 43 & 1674 \pm 177 & 1677 \pm 102 & 0.7 \\
		0.15 - 0.25 & 2254 \pm 25 & 2821 \pm 136 & 2486 \pm 87 & 0.8 \\
		0.25 - 0.35 & 2650 \pm 17 & 3170 \pm 128 & 2772 \pm 74 & 1.4 \\
		0.35 - 0.44 & 2905 \pm 11 & 3016 \pm 128 & 3216 \pm 68 & 1.1 \\
		0.44 - 0.56 & 3011 \pm 8 & 3158 \pm 153 & 3350 \pm 53 & 2.4 \\
		0.56 - 0.65 & 2884 \pm 11 & 2764 \pm 133 & 3051 \pm 70 & 1.7 \\
		0.65 - 0.75 & 2634 \pm 16 & 2857 \pm 135 & 2550 \pm 85 & 1.1 \\
		0.75 - 0.85 & 2312 \pm 23 & 2153 \pm 151 & 2117 \pm 91 & 1.2 \\
		0.85 - 0.94 & 2025 \pm 34 & 1825 \pm 167 & 1414 \pm 113 & 0.5 \\
		\enddata
...
We compared the TP profiles from the GCM to cloud condensation curves and the best fit radiative-convective equilibrium models from the 1D retrieval (Figure\,\ref{fig:TP}).

\begin{figure}
\includegraphics[width = 0.5\textwidth]{Figures/WASP-103b-NoClouds-Drag3-nit-LR.pdf}
\caption{TP profiles from the GCM (thin colored lines) and 1D retrievals (thick lines), compared to condensation curves of potential cloud species. The blue, green, and red lines correspond to TP profiles randomly drawn from the FIXME GCM at orbital phases FIXME. The thick red and blue lines are the best fit 1D TP profiles for the dayside ($\phi = 0.5$) and nightside ($\phi = 0.1$), respectively.}
\label{fig:TP}
\end{figure}
