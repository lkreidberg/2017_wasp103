...
\caption{Dayside emission spectrum (points) compared to the best fit 1-D model (blue line) with $1\,\sigma$ uncertainty shaded in orange. We also show a blackbody model (fit to the WFC3 data only).}
\label{fig:dayside}
\end{figure}
