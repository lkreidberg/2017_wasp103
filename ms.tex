...
We performed several tests of the quality of the light curve fits.  First we predicted the level of scatter in the light curves based on photon noise alone, then compared this value to the root-mean-square (rms) of the fit residuals.  The expected photon-limited rms for the WFC3 spectrosopic light curves ranges from 430 - 530 parts per million (ppm). The measured rms was typically within 5\% of expectations for all spectroscopic channels, regardless of which brightness distribution was used to model the thermal phase variation.  The band-integrated WFC3 light curve has slighty larger rms than predicted (175 versus 122 ppm). There are a number of possible origins for this discrepancy, including imperfect background subtraction, variation in the position of the spatial scan on the detector, loss of flux outside the extraction window, and imperfect modeling of the astrophysical signal or instrument systematics. However, our analysis of the composition and thermal structure of the planet's atmosphere is based on the wavelength-dependent data (which reach the photon limit), so we do not further explore the small excess noise in the white light curve. 

The Spitzer 4.5 $\mu$m light curve rms is within 10\% of the photon noise limit (691 versus 640 ppm). The 3.6 $\mu$m light curve has significantly larger rms (797 versus 470 ppm).
