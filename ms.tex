...
In this paper we present spectroscopic phase curve observations of the hot Jupiter WASP-103b, measured with \HST/WFC3 and Spitzer/IRAC. This planet is an ideal target for phase curve observations, with an orbital period of just 22 hours and an equilbrium temperature of 2500 K \citep{gillon14}.  Previous observations of WASP-103b's atmosphere revealed a blackbody-like dayside emission spectrum, with possible evidence for a $K_\mathrm{S}$-band emission feature \citep{cartier17, delrez18}. The shape of the optical transmission spectrum is disputed, with some evidence for strong sodium and potassium absorption features that are consistent with expectations for a cloud-free atmosphere \citep{lendl17}, but other observations indicating a large optical scattering slope that is not fit well by theoretical models \citep{southworth16}. 


WASP-103b is an archetype of the class of ultra-hot Jupiters (with dayside temperatures $>2000\,\mathrm{K}$). Observations of the near-IR thermal emission spectra of these objects have been puzzling: some show absorption features, some show emission features, and some are consistent with blackbody models \citep{madhusudhan11, crossfield12, stevenson14b, haynes15, evans16, beatty17a, beatty17b, }.  A variety of explanations have been proposed, including low metallicity or carbon-to-oxygen ratios \citep{madhusudhan11, cartier17}, which would TiO/VO heating of the upper atmosphere, . 

Our phase-curve observations of provide the first 3D constraints on temperature structure of a planets.

%	spin-orbit alignment: 2016ApJ...823...29A

%are featureless (consistent with a blackbody model for the planet), others show water absorption features, and water emission \citep{evans16}. Isothermal in the near-IR \citep{crossfield12, stevenson14, }. Some have absortion features in near-IR \citep{kreidberg14b, line16}
