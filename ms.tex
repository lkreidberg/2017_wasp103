...
All of the models provide good fits to the observed phase curves. Table\,\ref{tab:model_comparison} summarized the goodness of fit according to the reduced $\chi^2$, Bayesian information criterion (BIC), and Aikike information criterion (AIC). These metrics for assessing fit quality are . The AIC penalizes model complexity relatively LESS? than the BIC. 
Spherical harmonics provide the best fit most of the time.
